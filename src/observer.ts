import type { AllComponentTypes, AnyComponent, EntityId } from "types/ecs";

import { SparseSet } from "./collections/sparse-set";
import type { Internal } from "./component";
...
export class Observer {
	...
	private readonly requiredComponents: Array<AllComponentTypes> = [];
